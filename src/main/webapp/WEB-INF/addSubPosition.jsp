...
<title>ข้อมูลระดับ มหาวิทยาลัยราชภัฏบุรีรัมย์</title>
...
<!-- 	<script src="/DataTables-1.10.18/js/jquery.dataTables.min.js"></script>	 -->
	...
	<script src="/js/add-sub-position.js"></script>
...
<body class="w3-light-grey w3-content" style="max-width: 100%">
	...
	<form name="welcome" action="#" method="post" class="modal-content w3-animate-bottom" style="width: 90%; margin-top: 3%; margin-left: 5%">
		...
		<div class="w3-container w3-blue" align="left">
			<h2><i class="glyphicon glyphicon-folder-open w3-margin-right"></i>ข้อมูลระดับ มหาวิทยาลัยราชภัฏบุรีรัมย์</h2>
		</div>
		<button type="button" class="btn btn-info" data-toggle="modal" data-target="#Modal" style="margin: 1%">เพิ่มระดับ</button>
		<div style="overflow: auto;" >
		<div class="w3-container w3-white w3-padding-16">
			<table id="addSubPositionTable" class="table table-striped table-bordered nowrap" style="width: 100%; margin-top: 5%;">
				<thead>
					<tr style="background: purple; color: white;">
						<th style="text-align: center">รหัสระดับ</th>
