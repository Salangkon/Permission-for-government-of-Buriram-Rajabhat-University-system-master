...
<body>
	...
	<div id="main" style="margin-left:200px">
		...
		<div class="w3-container w3-display-container" style="background-color: gray;" id="grad1">
			<span title="open Sidebar" style="display:none" id="openNav" class="w3-button w3-transparent w3-display-topleft w3-xlarge"
			...
			<div id="printableArea">
				<div class="page" id="1">
					...
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							...
							<th style="max-width: 10mm;"><label>
									<%=bean.getDepartmentName()%></label></th>
							<th style="max-width: 2mm;">สังกัด</th>
							<th style="max-width: 10mm; text-align: left;"><label>
									<%=bean.getFacultyName()%></label></th>
						</tr>
						<tr>
					...
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							...
							<th style="max-width: 12mm;"><label>
									<%=bean.getSex() %>
									<%=bean.getUserFname()%>&nbsp;&nbsp;
									<%=bean.getUserLname()%></label></th>
							<th style="max-width: 2.5mm;">ตำเเหน่ง</th>
							<th style="max-width: 8mm;"><label>
									<%=bean.getDepartmentName()%></label></th>
						</tr>
						<tr>
							<th colspan="4" style="text-align: left">&nbsp;&nbsp;
								พร้อมด้วยคณะ รวม &nbsp;&nbsp;
								<%=beanEs.getUserSumTotal()%> คน <label>(ดังรายชื่อที่ระบุในใบประมาณการรายจ่ายที่แนบ)</label>
							</th>
						</tr>
					</table>
					<br>
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							<th style="max-width: 100%; text-align: left">3.
								ขอไปราชการในฐานะ : &nbsp;&nbsp; <input name="status" id="status1" type="radio" value="ผู้บริหาร" <%if
								 (bean.getStatus().equals("ผู้บริหาร")) { out.print("checked='checked' disabled"); }%>
								disabled> ผู้บริหาร &nbsp;&nbsp; <input name="status" id="status1" type="radio" value="ผู้สอน" <%if
								 (bean.getStatus().equals("ผู้สอน")) { out.print("checked='checked' disabled"); }%>
								disabled> ผู้สอน &nbsp;&nbsp; <input name="status" id="status1" type="radio" value="ผู้สนับสนุนการสอน" <%if
								 (bean.getStatus().equals("ผู้สนับสนุนการสอน")) { out.print("checked='checked' disabled"); }%>
								disabled> ผู้สนับสนุนการสอน
							</th>
						</tr>
						<tr>
							<th colspan="4" style="text-align: left; height: 20mm;" valign="top">&nbsp;&nbsp;&nbsp; เพื่อ
								(ระบุวัตถุประสงค์/ลักษณะงาน) &nbsp;&nbsp;&nbsp;<label>
									<%=bean.getObject()%></label>
							</th>
						</tr>
						<tr>
					...
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							<th style="max-width: 6mm; text-align: left">4.
								ไปราชการในวันที่</th>
							<th style="max-width: 12mm;"><label>
									<%=bean.getGoDate()%></label></th>
							<th style="max-width: 6mm;">ออกเดินทางเวลา</th>
							<th style="max-width: 5mm;"><label>
									<%=bean.getGoTime()%>
								</label></th>
						</tr>
						<tr>
					...
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							...
							<th style="max-width: 18mm; text-align: left"><input name="v" type="checkbox" value="เบิกค่าใช้จ่าย" <%if
								 (bean.getBudget().equals("เบิกค่าใช้จ่าย")) { out.print("checked='checked' disabled"); }%>
								disabled> เบิกค่าใช้จ่าย &nbsp;&nbsp; <input name="a" type="checkbox" value="ตามสิทธิ์" <%if
								 (bean.getBudgetExpenses().equals("ตามสิทธิ์")) { out.print("checked='checked' disabled"); }%>
								disabled> ตามสิทธื์ &nbsp;&nbsp; <input name="a" type="checkbox" value="เหมาจ่าย" <%if
								 (bean.getBudgetExpenses().equals("เหมาจ่าย")) { out.print("checked='checked' disabled"); }%>
								disabled> เหมาจ่าย &nbsp;&nbsp;</th>
						</tr>
						<tr>
							<th style="max-width: 4mm; text-align: left"></th>
							<th style="max-width: 18mm; text-align: left"><input name="v" type="checkbox" value="ไม่เบิกค่าใช้จ่าย" <%if
								 (bean.getBudget().equals("ไม่เบิกค่าใช้จ่าย")) { out.print("checked='checked' disabled"); }%>
					...
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							<th style="max-width: 13mm; text-align: left">
								&nbsp;&nbsp;&nbsp; โดยใช้งบประมาณ</th>
							<th style="max-width: 15mm; text-align: left"><input name="f" type="checkbox" value="งบประมาณแผ่นดิน" <%if
								 (bean.getBudgetBy().equals("งบประมาณแผ่นดิน")) { out.print("checked='checked' disabled"); }%>
						...
						<tr>
							...
							<th style="max-width: 18mm; text-align: left"><input name="f" type="checkbox" value="งบรายได้" <%if
								 (bean.getBudgetBy().equals("งบรายได้")) { out.print("checked='checked' disabled"); }%>
						...
						<tr>
							<th style="max-width: 12mm; text-align: left"></th>
							<th style="max-width: 18mm; text-align: left"><input name="f" type="checkbox" value="อื่นๆ" <%if
								 (bean.getBudgetBy().equals("อื่นๆ")) {out.print("checked='checked'");}%>>งบอื่นๆ
						</th>
						<th style="
								 max-width: 15mm; text-align: left" colspan="3"><label>
								</label></th>
						</tr>
						<tr>
							<th style="max-width: 12mm; text-align: left"></th>
					...
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							...
							<th style="max-width: 18mm; text-align: left" colspan="2"><input name="g" type="checkbox" value="พาหนะประจำทาง"
								 <%if (bean.getTravel().equals("พาหนะประจำทาง")) { out.print("checked='checked' disabled"); }%>
								disabled> ภาหนะประจำทาง</th>
						</tr>
						<tr>
							<th style="max-width: 7mm; text-align: left"></th>
							<th style="max-width: 18mm; text-align: left" colspan="2"><input name="g" type="checkbox" value="ขอใช้รถส่วนตัว"
								 <%if (bean.getTravel().equals("ขอใช้รถส่วนตัว")) { out.print("checked='checked' disabled"); }%>
								disabled> ขอใช้รถไปราชการ</th>
						</tr>
						<tr>
							<th style="max-width: 7mm; text-align: left"></th>
							<th style="max-width: 10mm; text-align: left"><input name="g" type="checkbox" value="ขอใช้รถไปราชการ" <%if
								 (bean.getTravel().equals("ขอใช้รถไปราชการ")) { out.print("checked='checked' disabled"); }%>
					...
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							...
							<th style="width: 20mm; text-align: left;"><input name="commitA" type="radio" <%if
								 (bean.getCommitA().equals("ไม่มี")) { out.print("checked='checked' disabled"); }%>
								disabled> ไม่มี</th>
							<th style="width: 20mm; text-align: left;"><input name="commitA" type="radio" <%if
								 (bean.getCommitA().equals("มี")) { out.print("checked='checked' disabled"); }%>
								disabled> มี</th>
						...
						<tr>
							...
							<th style="width: 20mm; text-align: left;"><input name="commitB" type="radio" <%if
								 (bean.getCommitB().equals("ไม่มี")) { out.print("checked='checked' disabled"); }%>
								disabled> ไม่มี</th>
							<th style="width: 20mm; text-align: left;"><input name="commitB" type="radio" <%if
								 (bean.getCommitB().equals("มี")) { out.print("checked='checked' disabled"); }%>
								disabled> มี</th>
							<th style="width: 100mm; text-align: left;">มอบหมายให้
								&nbsp;&nbsp;
								<%=bean.getCommitBDt()%>
						...
						<tr>
							...
							<th style="width: 20mm; text-align: left;"><input name="commitC" type="radio" <%if
								 (bean.getCommitC().equals("ไม่มี")) { out.print("checked='checked' disabled"); }%>
								disabled> ไม่มี</th>
							<th style="width: 20mm; text-align: left;"><input name="commitC" type="radio" <%if
								 (bean.getCommitC().equals("มี")) { out.print("checked='checked' disabled"); }%>
								disabled> มี</th>
							<th style="width: 100mm; text-align: left;">มอบหมายให้
								&nbsp;&nbsp;
								<%=bean.getCommitCDt()%>
						...
						<tr>
							...
							<th style="width: 20mm; text-align: left;"><input name="commitD" type="radio" <%if
								 (bean.getCommitD().equals("ไม่มี")) { out.print("checked='checked' disabled"); }%>
								disabled> ไม่มี</th>
							<th style="width: 20mm; text-align: left;"><input name="commitD" type="radio" <%if
								 (bean.getCommitD().equals("มี")) { out.print("checked='checked' disabled"); }%>
								disabled> มี</th>
							<th style="width: 100mm; text-align: left;">มอบหมายให้
								&nbsp;&nbsp;
								<%=bean.getCommitDDt()%>
				...
				<div class="page" id="2">
					...
					<table style="width: 100%; border-collapse: collapse;">
						...
						<tr>
							<th colspan="4" style="text-align: left">&nbsp;&nbsp; <input type="checkbox" value="ขออนุญาต" <%if
								 (bean.getPurpose().equals("ขออนุญาต")) { out.print("checked='checked' disabled"); }%>
								disabled> ขออนุญาต &nbsp;&nbsp; <input type="checkbox" value="ได้รับคำสั่ง" <%if
								 (bean.getPurpose1().equals("ได้รับคำสั่ง")) { out.print("checked='checked' disabled"); }%>
								disabled> ได้รับคำสั่ง &nbsp;&nbsp; <input type="checkbox" value="ไปราชการ" <%if
								 (bean.getPurpose2().equals("ไปราชการ")) { out.print("checked='checked' disabled"); }%>
								disabled>ไปราชการ &nbsp;&nbsp; เรื่อง &nbsp;&nbsp;
								<%=bean.getTopics()%>
							</th>
						</tr>
					</table>
					...
					<table style="width: 100%; border-collapse: collapse;">
						...
						<tr>
							<th style="text-align: left; max-width: 15mm;">
								&nbsp;&nbsp;&nbsp; <input name="v" type="checkbox" value="งบประมาณแผ่นดิน" <%if
								 (bean.getBudgetBy().equals("งบประมาณแผ่นดิน")) {out.print("checked='checked' disabled");}%>
								disabled> งบแผ่นดิน โครงการ
								<%=bean.getBudgetProject()%>
							</th>
						...
						<tr>
							<th style="text-align: left; max-width: 15mm;"> &nbsp;&nbsp;&nbsp;
								<input name="v" type="checkbox" value="งบรายได้" <%if (bean.getBudgetBy().equals("งบรายได้"))
								 {out.print("checked='checked' disabled");}%>disabled> งบเงินรายได้ โครงการ
								<%=bean.getBudgetProject()%>
							</th>
							<th style="text-align: left; max-width: 15mm;">รหัสโครงการ &nbsp;&nbsp;
						...
						<tr>
							<th colspan="2" style="max-width: 100%; text-align: left">&nbsp;&nbsp;
								โดยขอเบิกค่าใช้จาย <input name="v" type="checkbox" value="ตามสิทธิ์" <%if
								 (bean.getBudgetExpenses().equals("ตามสิทธิ์")) {out.print("checked='checked' disabled");}%>disabled> ตามสิทธื์
								&nbsp;&nbsp;
								<input name="v" type="checkbox" value="เหมาจ่าย" <%if (bean.getBudgetExpenses().equals("เหมาจ่าย"))
								 {out.print("checked='checked' disabled");}%>disabled> เหมาจ่าย &nbsp;&nbsp;
								<label style="margin-right: 5%"> เป็นจำนวนเงิน </label>
								<%=beanEs.getExpenseEstimateSumTotal()%><label>style="margin-left: 5%">บาท </label>
							</th>
						</tr>
					</table>
					<br>
					...
					<table id="customers" align="center" style="width: 100%;">
						...
						<tr>
							<th>
								...
								%>
									<tr>
										<td style="text-align: left; width: 35mm"><label style="margin-left: 5%;">
												<%=3%>.
												<%=3%>.
												<%=i + 1%>
												<%=beanTr.get(i).getVehicleName()%></label>
										</td>
								...
								<table>
									...
									<tr>
										...
										<td style="text-align: left; width: 60mm">
											<label>
												<%if (beanTEFC.getExpresswayExpensesSum() == 0) {out.print("");} else {out.print(beanTEFC.getExpresswayExpensesSum());}%></label></td>
										<td style="text-align: left; width: 6mm"><label>บาท</label></td>
									</tr>
									<tr>
								...
								<table style="width: 100%;">
									<tr>
										<td style="text-align: left;"><label>
												<%=beanEs.getAllowenceSumTotal()%></label></td>
									</tr>
									<tr>
										<td style="text-align: left; width: 25mm"><label>
												<%=beanEs.getRentDateSumTotal()%></label></td>
									</tr>
									<tr>
						...
						<tfoot>
							<tr>
								...
								<th><label>
										<%=beanEs.getExpenseEstimateSumTotal()%></label></th>
								<th></th>
							</tr>
						</tfoot>
					</table>
						...
						<tr align="left">
							<th valign="top" style="max-width: 45mm">
								...
								<div align="left">
									...
									<input name="v" type="checkbox"> งบรายได้ &nbsp;&nbsp; <input name="v" type="checkbox"> งบอื่นๆ &nbsp;&nbsp;
								</div>
								<div align="left">
									<label>รหัส</label>
									................................................................
				...
				<div class="page" id="3">
					...
					<div style="margin-bottom: 6%">
						<label style="margin-right: 3%">1. <input name="v" type="checkbox"> หัวหน้าสาขาวิชา
						</label> <label style="margin-left: 3%; margin-right: 3%"> <input name="v" type="checkbox"> หัวหน้างาน
						</label> <label style="margin-left: 3%; margin-right: 3%"><input name="v" type="checkbox"> หัวหน้าฝ่าย
							....................... </label> <br> <label style="margin-left: 3%; margin-right: 3%"> เห็นด้วย </label> <label
						 style="margin-left: 3%; margin-right: 3%"><input name="v" type="checkbox"> อนุญาต </label> <label style="margin-left: 5%;">
							โดยใช้งบ........รหัส.........จำนวน......บาท </label> <br> <label style="margin-left: 18%; margin-right: 3%"><input
							 name="v" type="checkbox"> ไม่อนุญาต </label> <label style="margin-left: 3%;">เนื่องจาก..............................
						</label> <br>
					...
					<div style="margin-bottom: 6%">
						<label>2. <input name="v" type="checkbox">
							...
							หัวหน้าสำนักงานเลชานุการคณะ / สำนัก / สถาบัน </label> <br> <label style="margin-left: 3%; margin-right: 3%">
							เห็นด้วย </label> <label style="margin-left: 3%; margin-right: 3%"><input name="v" type="checkbox"> อนุญาต
						</label> <label style="margin-left: 5%;">
							โดยใช้งบ........รหัส.........จำนวน......บาท </label> <br> <label style="margin-left: 18%; margin-right: 3%"><input
							 name="v" type="checkbox"> ไม่อนุญาต </label> <label style="margin-left: 3%;">เนื่องจาก..............................
						</label> <br>
					...
					<div style="margin-bottom: 6%">
						<label>3. การสั่งการ </label><br> <label style="margin-left: 2%;"><input name="v" type="checkbox">
							อนุญาต <u>มอบงานธุรการ</u>จัดทำสั่งโดย </label> <label><input name="v" type="checkbox">
							เบิกค่าใช้จ่ายตามประมาณการ </label> <label><input name="v" type="checkbox"> ไม่เบิกค่าใช้จ่าย </label> <br>
						<label style="margin-left: 2%;"><input name="v" type="checkbox">
							ไม่อนุญาต </label> <br> <label style="margin-left: 2%;"><input name="v" type="checkbox"> นำเสนอรองอธิการบดี
							(เกิน 30,000)</label>
						<br>
						...
						<label><input name="v" type="checkbox"> เบิกค่าใช้จ่ายตามประมาณการ </label> <label><input name="v" type="checkbox">
							ไม่เบิกค่าใช้จ่าย</label> <br> <label style="margin-left: 2%;"><input name="v" type="checkbox">
							ไม่อนุญาต </label> <br> <label style="margin-left: 2%;"><input name="v" type="checkbox"> นำเสนอรองอธิการบดี
							(เกิน 50,000)
						</label> <br>
						<div style="margin-left: 20%; margin-top: 4%; margin-bottom: 6%">
