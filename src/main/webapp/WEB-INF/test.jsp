...
<div class="w3-sidebar w3-light-grey w3-card-4 w3-animate-left" style="width:200px" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-green" href="/welcomeUser">Back</a>
  <a class="w3-bar-item w3-button" href="1">Print</a>
...
<div class="w3-container w3-display-container">
  <span title="open Sidebar" style="display:none" id="openNav" class="w3-button w3-transparent w3-display-topleft w3-xlarge" onclick="w3_open()">&#9776;</span>
	...
	<div class="page">
		...
		<h4 align="center">
			<b>มหาวิทยาลัยราชภัฏบุรีรัมย์ <br>บันทึกขออนุญาตไปราชการ</b>
		</h4>
		<hr><br>
...
<table style="width: 100%; border-collapse: collapse;">
  ...
  <tr>
    <th colspan="4" style=" max-width: 4mm;right: 1em;text-align:left"> &nbsp;&nbsp; วันที่   <%=bean.getDate()%></th>
  </tr>
</table>
<br>
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    ...
    <th style=" max-width: 12mm;"><label> <%=bean.getUserFname()%>  &nbsp;&nbsp; <%=bean.getUserLname()%> </label></th>
    <th style=" max-width: 2.5mm;">ตำเเหน่ง</th>
    <th style=" max-width: 8mm;"><label> <%=bean.getDepartmentName()%></label></th>
  </tr>
  <tr>
    <th colspan="4" style="text-align:left"> &nbsp;&nbsp; พร้อมด้วยคณะ รวม  &nbsp;&nbsp; <%=beanEs.getUserSumTotal()%>  คน
    <label>(ดังรายชื่อที่ระบุในใบประมาณการรายจ่ายที่แนบ)</label>  </th>
  </tr>
</table>
<br>
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <th style=" max-width: 100%;text-align:left">3. ขอไปราชการในฐานะ :  &nbsp;&nbsp; 
		<input name="status" id="status1" type="radio" value="ผู้บริหาร" <%if (bean.getStatus().equals("ผู้บริหาร")) { out.print("checked ='checked'  disabled"); }%> 		disabled> ผู้บริหาร &nbsp;&nbsp; 
		<input name="status" id="status1" type="radio" value="ผู้สอน" <%if (bean.getStatus().equals("ผู้สอน")) { out.print("checked ='checked' 	disabled");}%>	 	disabled> ผู้สอน &nbsp;&nbsp; 
		<input name="status" id="status1" type="radio" value="ผู้สนับสนุนการสอน" <%if (bean.getStatus().equals("ผู้สนับสนุนการสอน")) { out.print("checked ='checked' disabled"); }%> disabled> ผู้สนับสนุนการสอน
    </th>
  </tr>
  <tr>
     <th colspan="4" style="text-align:left;height: 20mm;" valign="top">&nbsp;&nbsp;&nbsp; เพื่อ (ระบุวัตถุประสงค์/ลักษณะงาน) &nbsp;&nbsp;&nbsp;<label><%=bean.getObject()%></label></th>
  </tr>
  <tr>
  	<th style=" max-width: 4mm;text-align:left"><label>&nbsp;&nbsp;&nbsp;ให้แนบเอกสารโครงการ/กิจกรรมที่ระบุรายละเอียด หรือ เหตุผลเพิ่อประกอบการพิจารณา (ถ้ามี) : </label></th>
  </tr>
  </table>
  <br>
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <th style=" max-width: 6mm;text-align:left">4. ไปราชการในวันที่ </th>
    <th style=" max-width: 12mm;"><label> <%=bean.getGoDate()%></label></th>
    <th style=" max-width: 6mm;">ออกเดินทางเวลา</th>
    <th style=" max-width: 5mm;"><label> <%=bean.getGoTime()%> </label></th>
  </tr>
  <tr>
    <th style=" max-width: 2mm;text-align:left"> &nbsp;&nbsp;&nbsp; ถึงวันที่ </th>
    <th style=" max-width: 12mm;"><label> <%=bean.getBackDate()%> </label></th>
    <th style=" max-width: 6mm;">เดินทางกลับถึงเวลา </th>
    <th style=" max-width: 5mm;"><label> <%=bean.getBackTime()%> </label></th>
  </tr>
</table>
  <br>
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <th style=" max-width: 6mm;text-align:left">5. สถานที่ไปราชการ ชื่อหน่วยงาน </th>
  ...
  <tr>
    ...
    <th style=" max-width: 12mm;text-align:left"><label> จังหวัด   &nbsp;&nbsp;&nbsp;  <%=bean.getProvince() %></label></th>
  </tr>
</table>
   <br>
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    ...
    <th style=" max-width: 18mm;text-align:left">
    	<input name="v" type="checkbox" value="เบิกค่าใช้จ่าย" 	<%if (bean.getBudget().equals("เบิกค่าใช้จ่าย")) {out.print("checked ='checked' disabled");}%>			disabled> เบิกค่าใช้จ่าย &nbsp;&nbsp; 
   		<input name="a" type="checkbox" value="ตามสิทธิ์" 	<%if (bean.getBudgetExpenses().equals("ตามสิทธิ์")) {out.print("checked ='checked' disabled");}%>	disabled> ตามสิทธื์ &nbsp;&nbsp; 
    	<input name="a" type="checkbox" value="เหมาจ่าย" 	<%if (bean.getBudgetExpenses().equals("เหมาจ่าย")) {out.print("checked ='checked' disabled");}%>	disabled> เหมาจ่าย &nbsp;&nbsp; 
    </th>
  </tr>
  <tr>
    <th style=" max-width: 4mm;text-align:left"></th>
     <th style=" max-width: 18mm;text-align:left"> 
     	<input name="v" type="checkbox" value="ไม่เบิกค่าใช้จ่าย" <%if (bean.getBudget().equals("ไม่เบิกค่าใช้จ่าย")) {out.print("checked ='checked' disabled");}%> 	disabled> ไม่เบิกค่าใช้จ่าย &nbsp;&nbsp;  </th>
  </tr>
</table>
   <br>
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <th style=" max-width: 13mm;text-align:left"> &nbsp;&nbsp;&nbsp; โดยใช้งบประมาณ</th>
    <th style=" max-width: 15mm;text-align:left">
    	<input name="f" type="checkbox" value="งบประมาณแผ่นดิน"<%if (bean.getBudgetBy().equals("งบประมาณแผ่นดิน")) { out.print("checked ='checked' disabled");}%>	disabled>
		 <label>งบแผ่นดิน </label> &nbsp;&nbsp;โครงการ &nbsp;&nbsp;
    </th>
    <th style=" max-width: 15mm;text-align:left"><label><%if (bean.getBudgetBy().equals("งบประมาณแผ่นดิน")) {out.print(bean.getBudgetProject());}%></label></th>
    <th style=" max-width: 10mm;text-align:left"> รหัสโครงการ  </th>
    <th style=" max-width: 12mm;text-align:left"><label><%if (bean.getBudgetBy().equals("งบประมาณแผ่นดิน")) {out.print(bean.getBudgetPass());}%>  </label></th>
  </tr>
  <tr>
    <th style=" max-width: 12mm;text-align:left"> </th>
    <th style=" max-width: 18mm;text-align:left">
    	<input name="f" type="checkbox" value="งบรายได้" <%if (bean.getBudgetBy().equals("งบรายได้")){ out.print("checked ='checked' disabled");}%>	disabled>
    	<label>งบเงินรายได้ </label>&nbsp;&nbsp;โครงการ &nbsp;&nbsp;
    </th>
    <th style=" max-width: 15mm;text-align:left"><label><%if (bean.getBudgetBy().equals("งบประมาณแผ่นดิน")){ out.print(bean.getBudgetProject());}%></label></th>
    <th style=" max-width: 10mm;text-align:left"> รหัสโครงการ  </th>
    <th style=" max-width: 12mm;text-align:left"><label> <%if (bean.getBudgetBy().equals("งบรายได้")) {out.print(bean.getBudgetPass());}%> </label> </th>
  </tr>
    <tr>
    <th style=" max-width: 12mm;text-align:left"> </th>
    <th style=" max-width: 18mm;text-align:left"><input name="f" type="checkbox" value="อื่นๆ"
	    <%if (bean.getBudgetBy().equals("อื่นๆ")) {out.print("checked ='checked'");}%>>งบอื่นๆ
    </th>
    <th style=" max-width: 15mm;text-align:left" colspan="3"><label> </label></th>
  </tr>
  <tr>
    <th style=" max-width: 12mm;text-align:left"> </th>
    <th style=" max-width: 18mm;text-align:left">ในวงเงิน &nbsp;&nbsp; <%=beanEs.getExpenseEstimateSumTotal() %>  </th>
...
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <th style=" max-width: 9.5mm;text-align:left">7. การเดินทาง  </th>
    <th style=" max-width: 18mm;text-align:left" colspan="2">
    	<input name="g" type="checkbox" value="พาหนะประจำทาง"<%if (bean.getTravel().equals("พาหนะประจำทาง")) {out.print("checked ='checked' disabled");}%> disabled> ภาหนะประจำทาง
    </th>
  </tr>
  <tr>
    <th style=" max-width: 7mm;text-align:left"></th>
     <th style=" max-width: 18mm;text-align:left" colspan="2"> 
     	<input name="g" type="checkbox" value="ขอใช้รถส่วนตัว" <%if (bean.getTravel().equals("ขอใช้รถส่วนตัว")) {out.print("checked ='checked' disabled");}%> disabled> ขอใช้รถไปราชการ  
     </th>
  </tr>
  <tr>
    <th style=" max-width: 7mm;text-align:left" ></th>
     <th style=" max-width: 10mm;text-align:left"> 
     	<input name="g" type="checkbox" value="ขอใช้รถไปราชการ" <%if (bean.getTravel().equals("ขอใช้รถไปราชการ")) {out.print("checked ='checked' disabled");}%> disabled> ขอใช้รถส่วนตัว
     </th>
...
<table style="width: 100%; border-collapse: collapse;">
  <tr>
     <th  style="text-align:left;" ><label>8. การมอบหมายงานระหว่างไปราชการ </label></th>
  </tr>
</table>
<table style="width: 100%; border-collapse: collapse;">
	<tr>
		<th style="width: 100mm;text-align: left;">&nbsp;&nbsp;&nbsp; 8.1 งานสอนภาคปกติ</th>
		<th style="width: 20mm;text-align: left;"><input name="commitA" type="radio" <%if (bean.getCommitA().equals("ไม่มี")) {out.print("checked ='checked' disabled");}%> disabled> ไม่มี </th>
		<th style="width: 20mm;text-align: left;"><input name="commitA" type="radio" <%if (bean.getCommitA().equals("มี"))  { out.print("checked ='checked' disabled");}%> disabled> มี </th>
		<th style="width: 100mm;text-align: left;">มอบหมายให้ &nbsp;&nbsp; <%=bean.getCommitADt()%></th>
	</tr>
	<tr>
		<th style="width: 100mm;text-align: left;">&nbsp;&nbsp;&nbsp; 8.2 งานสอนภาค กศ.บป./บัณฑิตศึกษา</th>
		<th style="width: 20mm;text-align: left;"><input name="commitB" type="radio" <%if (bean.getCommitB().equals("ไม่มี")) {out.print("checked ='checked' disabled");}%> disabled> ไม่มี </th>
		<th style="width: 20mm;text-align: left;"><input name="commitB" type="radio" <%if (bean.getCommitB().equals("มี")) { out.print("checked ='checked' disabled"); }%> disabled> มี</th>
	...
	<tr>
		...
		<th style="width: 20mm;text-align: left;"><input name="commitC" type="radio" <%if (bean.getCommitC().equals("ไม่มี")) { out.print("checked ='checked' disabled"); }%> disabled> ไม่มี </th>
		<th style="width: 20mm;text-align: left;"><input name="commitC" type="radio" <%if (bean.getCommitC().equals("มี"))  { out.print("checked ='checked' disabled"); }%> disabled> มี </th>
	...
	<tr>
		...
		<th style="width: 20mm;text-align: left;"><input name="commitD" type="radio" <%if (bean.getCommitD().equals("ไม่มี")) { out.print("checked ='checked' disabled");}%> disabled> ไม่มี </th>
		<th style="width: 20mm;text-align: left;"><input name="commitD" type="radio" <%if (bean.getCommitD().equals("มี")) { out.print("checked ='checked' disabled");}%> disabled> มี </th>
...
<table style="width: 100%; border-collapse: collapse;margin-top: 2cm">
  ...
  <tr>
  	 <td style="width: 90mm"></td>
     <td valign="middle"><label style="margin-left: 6.5mm">(.............................................)</label> </td>
  </tr>
</table>
	...
	<div class="page">
		...
		<h4> &nbsp;&nbsp; ประมาณการรายจ่ายไปราชการ (ให้แนบพร้อมกับใบขออนุญาตกรณีขอเบิกค่าใช้จ่าย) </h4>

<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <th style=" max-width: 4mm;text-align:left">1. ข้าพเจ้า  </th>
    <th style=" max-width: 12mm;"><label>คณะมนุษยศาสตร์และสังคมศาสตร์ </label></th>
    <th style=" max-width: 2.5mm;">ตำเเหน่ง</th>
    <th style=" max-width: 8mm;"><label>สาขาวิชาเทคโนโลยีและค</label></th>
  </tr>
  <tr>
    <th colspan="4" style="text-align:left"> &nbsp;&nbsp;&nbsp; พร้อมด้วยผู้มีรายชื่อหน้า 2 รวม &nbsp;&nbsp;&nbsp; <label></label> &nbsp;&nbsp;  คน 
      (มีความประสงค์)</th>
  </tr>
  <tr>
    <th colspan="4" style="text-align:left"> &nbsp;&nbsp;
        <input type="checkbox" value="ขออนุญาต" <%if (bean.getPurpose().equals("ขออนุญาต")) { out.print("checked ='checked' disabled"); }%> disabled> ขออนุญาต &nbsp;&nbsp; 
        <input type="checkbox" value="ได้รับคำสั่ง" <%if (bean.getPurpose1().equals("ได้รับคำสั่ง")) { out.print("checked ='checked' disabled"); }%> disabled> ได้รับคำสั่ง &nbsp;&nbsp; 
        <input type="checkbox" value="ไปราชการ" <%if (bean.getPurpose2().equals("ไปราชการ")) { out.print("checked ='checked' disabled"); }%> disabled>ไปราชการ
...
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <th style="text-align:left;max-width: 16mm;"> &nbsp;&nbsp;&nbsp; ที่ &nbsp;&nbsp; <label><%=bean.getDestinationName()%> </label> </th>
    <th style="text-align:left;max-width: 11mm;"> อำเภอ &nbsp;&nbsp;<label><%=bean.getAmphur()%></label> </th>
    <th style="text-align:left;max-width: 11mm;"> จังหวัด &nbsp;&nbsp;<label><%=bean.getAmphur()%></label>  </th>
  </tr>
</table>
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <th style="text-align:left;max-width: 15mm;"> &nbsp;&nbsp; ในวันที่  &nbsp;&nbsp;&nbsp;&nbsp;<label> <%=bean.getGoDate()%> </label></th>
    <th style="text-align:left;max-width: 15mm;"> &nbsp;&nbsp; ถึงวันที่  &nbsp;&nbsp;&nbsp;&nbsp;<label> <%=bean.getBackDate()%></label> </th>
  </tr>
</table>
<br>
<table style="width: 100%; border-collapse: collapse;">
  ...
  <tr>
    ...
    <input name="v" type="checkbox" value="งบประมาณแผ่นดิน" <%if (bean.getBudgetBy().equals("งบประมาณแผ่นดิน")) { out.print("checked ='checked' disabled");}%> disabled> งบแผ่นดิน  โครงการ
				<%=bean.getBudgetProject()%></th>
    <th style="text-align:left;max-width: 15mm;">รหัสโครงการ &nbsp;&nbsp; <%if (bean.getBudgetBy().equals("งบประมาณแผ่นดิน")) {out.print(bean.getBudgetPass());}%> </th>
  </tr>
    <tr>
    <th style="text-align:left;max-width: 15mm;"> &nbsp;&nbsp;&nbsp; 
    <input name="v" type="checkbox" value="งบรายได้" <%if (bean.getBudgetBy().equals("งบรายได้")) { out.print("checked ='checked' disabled");}%> disabled> งบเงินรายได้ โครงการ
				<%=bean.getBudgetProject()%></th>
    <th style="text-align:left;max-width: 15mm;">รหัสโครงการ &nbsp;&nbsp;<% if (bean.getBudgetBy().equals("งบรายได้")) { out.print(bean.getBudgetPass());}%> </th>
  </tr>
  <tr>
    <th colspan="2" style="max-width: 100%;text-align:left"> &nbsp;&nbsp;&nbsp; <input name="v" type="checkbox" value="งบอื่นๆ" <%if (bean.getBudgetBy().equals("งบอื่นๆ")) { out.print("checked ='checked' disabled");}%> disabled> งบอื่นๆ &nbsp;&nbsp; </th>
  </tr>
  <tr>
    <th colspan="2" style="max-width: 100%;text-align:left">&nbsp;&nbsp; โดยขอเบิกค่าใช้จาย
    	<input name="v" type="checkbox" value="ตามสิทธิ์" <%if (bean.getBudgetExpenses().equals("ตามสิทธิ์")) { out.print("checked ='checked' disabled");}%> disabled> ตามสิทธื์ &nbsp;&nbsp; 
        ...
        <label style="margin-right: 5%"> เป็นจำนวนเงิน </label><%=beanEs.getExpenseEstimateSumTotal() %><label style="margin-left : 5%">บาท </label></th>
  </tr>
</table>
  <br>
  <table style="width: 100%; border-collapse: collapse;">
...
<table id="customers" align="center" style="width: 100%;">
	...
	<tr>
		<th>
            ...
            <% for (int i = 0; i < beanTr.size(); i++) {%>
				<tr>
					<td style="text-align:left;width: 35mm"><label style="margin-left: 5%;"> <%=3%>.<%=3%>.<%=i + 1%> <%=beanTr.get(i).getVehicleName()%></label> </td>
                    <td style="text-align:left;width: 5mm"><label>
                    <%if (beanTr.get(i).getTravelExpenses() == 0) {out.print("");} else {out.print(beanTr.get(i).getNumberPer());}%></label>
                    </td>
                    <td style="text-align:left;width: 10mm"><label>เที่ยวๆ ละ</label> </td>
                    <td style="text-align:left;width: 12mm"><label>
                    <%if (beanTr.get(i).getNumberPer() == 0) { out.print("");} else {out.print("(" + beanTr.get(i).getTravelExpenses() + "x" + beanTr.get(i).getUserSum()+")");}%></label>
                    </td>
			...
			<table>
				<tr>
					<td style="text-align:left;width: 40mm"> <label style="margin-left: 5%;">3.6.6  ค่าน้ำมันเชื้อเพลิง</label> </td>
					...
					<%if (beanTEFC.getDivide() == 0) {out.print("");} else {out.print( " / " + beanTEFC.getDivide());}%></label>
                    </td>
				...
				<tr>
                    ...
                    <td style="text-align:left;width: 60mm"><label>
                    <%if (beanTEFC.getExpresswayExpenses() == 0) {out.print("");} else {out.print("(" + beanTEFC.getExpresswayExpenses()  );}%>
					<%if (beanTEFC.getExpresswayNumberPer() == 0) {out.print("");} else {out.print( "x" + beanTEFC.getExpresswayNumberPer() + ")");}%></label>
					</td>
                    <td style="text-align:left;width: 6mm"><label>บาท</label></td>
				</tr>
				<tr>
		...
		<table style="width: 100%;">
            ...
            <% for (int i = 0; i < beanTr.size(); i++) {%>
				<tr>
                    <td style="text-align:left;width: 12mm"><label>
                    <%if (beanTr.get(i).getSum() == 0) { out.print("....");} else {out.print(beanTr.get(i).getSum());}%></label>
                    </td>
				</tr>
			<%}%>
			</table>
			<table>
				<tr>
                    <td style="text-align:left;"><label><%if (beanTEFC.getFuelCostSum() == 0) {out.print("...");} else {out.print( + beanTEFC.getFuelCostSum() );}%></label></td>
				</tr>
				<tr>
                    <td style="text-align:left;width: 60mm"><label><%if (beanTEFC.getExpresswayExpensesSum() == 0) {out.print("....");} else {out.print(beanTEFC.getExpresswayExpensesSum());}%></label></td>
				</tr>
				<tr>
					<td colspan="5" style="text-align:left"><label>...</label> </td>
				</tr>
	...
	<div align="right" style="margin-bottom: 3%; margin-top: 3%"><label>(ลงชื่อ).............................................ผู้ประมาณการ</label><br></div>
				...
				<tr align="left">
					<th valign="top" style="max-width: 45mm">
						...
						<div align="left">
							...
							<input name="v" type="checkbox"> งบรายได้ &nbsp;&nbsp; 
							<input name="v" type="checkbox"> งบอื่นๆ &nbsp;&nbsp;
						</div>
						<div align="left">
						<label>รหัส</label> ................................................................
						</div>
		...
		<div class="page">
			...
			ผ่านผู้บังคับบัญชาในสายงานที่ขอไปราชการตามลำดับ</label>
			<br>
		...
		<div style="margin-bottom: 6%">
			<label style="margin-right: 3%">1. <input name="v"
				...
				type="checkbox"> ไม่อนุญาต </label> <label style="margin-left: 3%;">เนื่องจาก..............................
			</label> <br>
		...
		<div style="margin-bottom: 6%">
			<label>3. การสั่งการ </label><br> <label
				...
				name="v" type="checkbox"> นำเสนอรองอธิการบดี (เกิน 30,000)</label> <br>
			...
			<label style="margin-left: 2%;"><input name="v"
				...
				style="margin-left: 2%;"><input name="v" type="checkbox">
				ไม่อนุญาต </label> <br> <label style="margin-left: 2%;"><input
				name="v" type="checkbox"> นำเสนอรองอธิการบดี (เกิน 50,000) </label> <br>
			<div style="margin-left: 20%; margin-top: 4%; margin-bottom: 6%">
	...
	<div class="page">
		...
		<div style="size: 10; margin-bottom: 5%" class="col-sm-12">
			...
			<table id="customers" style="margin-bottom: 10mm; margin-top: 10mm">
				...
				<tr>
					<th colspan="3">
						<label style="margin-left: 10%">รวม</label>
						 <label style="margin-left: 10%"><%=beanEs.getUserSumTotal()%></label> 
						<label style="margin-left: 25%">คน</label><label style="margin-left: 23%">รวมเงิน</label>
					</th>
